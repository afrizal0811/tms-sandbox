...
export const dictionary = {
  id: {
    common: {
      ...
      actual_departure: 'Waktu Keberangkatan Aktual',
      actual_seq: 'Urutan Aktual',
      address: 'Alamat',
      all: 'Semua',
      apply: 'Terapkan',
      ...
      travel_distance_actual: 'Aktual Jarak Perjalanan (km)',
      travel_distance_plan: 'Perkiraan Jarak Perjalanan (km)',
      travel_duration_actual: 'Aktual Durasi Perjalanan (jam)',
      travel_duration_plan: 'Perkiraan  Durasi Perjalanan (jam)',
      travel_time_actual: 'Aktual Waktu Perjalanan',
      travel_time_plan: 'Perkiraan Waktu Perjalanan',
      type: 'Tipe',
    ...
    report: {
      ...
      tooltip: {
        ...
        service_level_info: 'Laporan perhitungan perjanjian tingkat layanan',
    ...
    setting: {
      ...
      tab: {
        general: {
          ...
          partial_routing_title: 'Ruting Sebagian',
    ...
    task_detail: {
      ...
      modal: {
        ...
        creation: 'Pembuatan',
        done_coord: 'Koordinat Selesai',
        expected_coord: 'Koordinat Ekspektasi',
        history: 'Riwayat',
  ...
  en: {
    common: {
      ...
      travel_distance_actual: 'Actual Travel Distance (km)',
      travel_distance_plan: 'Planned Travel Distance (km)',
      travel_duration_actual: 'Actual Travel Duration (hour)',
      travel_duration_plan: 'Planned Travel Duration (hour)',
      travel_time_actual: 'Actual Travel Time',
      travel_time_plan: 'Planned Travel Time',
      type: 'Type',
    ...
    report: {
      ...
      custom: {
        ...
        task_manual: 'Manual Tasks',
        task_routing: 'Routing Tasks',
        trip_activity: 'Trip Activity',
      },
      task_count: {
        title: 'Task Count Report',
        choose_hub: 'Select HUB',
        custom_time: 'Custom Time Range',
        date_range: 'Time Range',
        note_one: '*Note: Server only stores deletion (trash) history for the last 30 days.',
      ...
      manual_input: {
        ...
        routing_guide: {
          step_1:
            '1. Log in to MileApp, then open the Routes menu on the left sidebar. Select the Results submenu.',
          step_2: '2. Filter data by routing date.',
          step_3: '3. Select the assigned routing result.',
          step_4:
            '4. Click the Export button to download the file. Repeat this for all routing results.',
        },
        delivery_guide: {
          step_1: '1. Log in to MileApp, then open the Tasks menu on the left sidebar.',
          step_2: '2. Filter data by delivery status and date.',
          step_3: '3. Click the Export button, then click Export Tasks.',
          step_4:
            '4. Open the Import & Export menu on the left sidebar. Select the Data Export submenu.',
          step_5: '5. Click the download icon in the Actions column to download the file.',
        },
      },
      toast: {
        ...
        skip_data: '{skippedDates} dates have no data',
        skip_sunday: 'Skipped {sundaysSkipped} Sundays',
      },
      tooltip: {
        cut_off: 'Cut-off Time',
        info_change_time: 'For non-D-1 routing',
        info_delivery: 'Automatic D-1 routing',
        service_level_info: 'Report of calculation of service level agreement',
        task_manual_info: 'Report of tasks containing manual assignment information',
        task_routing_info: 'Report of tasks containing routing data',
        trip_activity_info: 'Report of driver activities',
      },
    },
    excel: {
      reports: {
    ...
    setting: {
      ...
      tab: {
        general: {
          ...
          partial_routing_title: 'Partial Routing',
    ...
    task_detail: {
      ...
      modal: {
        ...
        waiting_time: 'Waiting Time (hour)',
      },
    },
    tracking: {
